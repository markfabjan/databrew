...
<?php
	...
	$sql = 'SELECT media.id, media.id as mid, media.title, media.description, media.views, media.thumb, users.username, media.userID, users.id FROM media, users WHERE media.userID = users.id ORDER BY views ;';
